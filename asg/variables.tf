...
variable "ia_video_codec" {
  type        = string
  description = "(Optional) Sets video codec for Iris Anywhere streams. Default is VP8."
  default     = "VP8"
}
...
variable "saml_enabled" {
  type        = bool
  description = "Enabled SAML on Iris Anywhere Instances"
  default     = false
}

variable "saml_cert_secret_arn" {
  type        = string
